...
st.markdown('<div class="space">달달하고 상큼한 원샷 칵테일</div>', unsafe_allow_html=True)
...
st.markdown('<div class="space">데킬라 베이스의 생라임과 허브가 들어간 칵테일</div>', unsafe_allow_html=True)
